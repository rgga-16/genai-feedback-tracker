...
Make sure that you describe the tasks, problems, insights, and important reminders in a clear and concise manner.
...
Insights:
- Insight 1: [Insight description] (Timestamp: [Timestamp])
...
- Insight n: [Insight description] (Timestamp: [Timestamp])
